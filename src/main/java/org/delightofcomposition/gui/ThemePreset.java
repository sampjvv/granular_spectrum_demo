...
public enum ThemePreset {
    ...
    PAPER_MINIMALIST("Paper Minimalist",
        ...
        /* BG (light beige page), BG_CARD/INPUT (light warm), BG_MUTED */
        c(0xFA,0xF7,0xF3), c(0xFA,0xF8,0xF5), c(0xF0,0xEE,0xEB), c(0xFA,0xF8,0xF5),
        /* BORDER, BORDER_SUBTLE */
        c(0xCC,0xCC,0xCC), c(0xDD,0xDD,0xDD),
